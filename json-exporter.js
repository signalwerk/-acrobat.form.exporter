...
function importForm(strJSON) {
	...
	if (importObj.version === 1.0) {
		...
		app.alert("Diese Version des Formulars ist mit ihren Daten nicht kompatibel. Import wurde abgebrochen.", 1);
	}
}
...
function formGenerate() {
	...
	if (checkID()) {
		app.alert("Achtung! Feldnamen sind nicht eindeutig. Formular wurde nicht korrekt erzeugt.");
	}
